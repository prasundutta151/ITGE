...
int win(double *image,long xdim,long ydim,char *catlog)
{
...
int disk(double *image,long xdim,long ydim,char *catlog)
{
  int ii,jj,ii1,jj1,ll,mm,nn=4,index,test=1;
  int xmin,xmax,ymin,ymax;
...
int inver_disk(double *image,long xdim,long ydim,char *catlog)
{
  int ii,jj,ii1,jj1,ll,mm,nn=4,index,test=1;
  int xmin,xmax,ymin,ymax;
  double thetax,thetay,width,dist2;
...
int exp_sinc(double *image,long xdim,long ydim,char *catlog)
{
  int ii,jj,ii1,jj1,ll,mm,nn=4,index,test=1;
  int xmin,xmax,ymin,ymax;
  double thetax,thetay,width,dist2;
...
int radial(double *image,long xdim,long ydim,char *catlog)
{
  int ii,jj,ii1,jj1,ll,mm,nn=4,index,test=1;
  int xmin,xmax,ymin,ymax;
...
int butterworth(double *image,long xdim,long ydim,char *catlog)
{
  int ii,jj,ii1,jj1,ll,mm,nn=4,index,test=1;
  int xmin,xmax,ymin,ymax;
  double thetax,thetay,width,dist2,n=1.;
  FILE *fp;
...
int butterworthannular(double *image,long xdim,long ydim,char *catlog)
{
  int ii,jj,ii1,jj1,ll,mm,nn=4,index,test=1;
  int xmin,xmax,ymin,ymax;
...
int disk_gauss(double *image,long xdim,long ydim,char *catlog)
{
  int ii,jj,ii1,jj1,ll,mm,nn=4,index,test=1;
  int xmin,xmax,ymin,ymax;
  double thetax,thetay,width,dist2,n=2.;
